...
*/
	...
	/*if ($MetaID == 1)
		...
		*/
		$sql="select * from csc_lr_experiment_req where experiment_current_snapshot='81' or experiment_current_snapshot='71' order by request_theme";
	...
	<br/><br/>
		...
		<tr><th colspan="4" class="theme-details-l">Ideas for Ingenuity Worx Evaluation</th></tr>
	...
	//echo $sql;
			...
			?>
				<tr>
					...
					<td><a href="viewanideaforiwapproval.php?req_no=<?php echo $row['request_num']?>" ><?php print $row['expt_shortname']; ?></a></td>	
		...
		<!--<div align="right">
		<br/>
		<input type="button" name="export_report" class="controltext" id="export_report" <?php if ($expt_snapshots_name=="") {?> disabled <?php }?> value="Export to Spreadsheet" onclick="javascript:window.open('iwideas_exporttoexcel.php');" >
		</div>-->
		<!--<div>
		<?php
