<?php
	...
	*/
	...
	//$filename = "IdeasExport"."_".date('Ymd').".xlsx";
	$filename = "IdeasForIWExport"."_".date('Ymd').".xls";
...
$skillquery="SELECT * FROM csc_lr_experiment_req where experiment_current_snapshot='81' or experiment_current_snapshot='71' order by request_theme";
