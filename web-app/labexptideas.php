...
*/
	...
	/*if ($MetaID == 1)
		...
		*/
		...
		$wherecondition="experiment_current_snapshot";
		$wherevalue="700";
	...
	*/
	$query = "SELECT COUNT(*) as num FROM $tbl_name where $wherecondition > $wherevalue";
	...
	{
	*/
		$sql = "SELECT * FROM $tbl_name where $wherecondition > $wherevalue order by request_theme LIMIT $start, $limit";
		$skill_metadatas = mysql_query($sql);
	//}
...
<br/><br/>
	...
	<br/><br/>
		...
		<tr><th colspan="4" class="theme-details-m">View Lab Experiment Ideas</th></tr>
