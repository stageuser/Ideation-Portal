...
if($auth==0)
{
	...
	$sql = "SELECT * FROM  `csc_lr_experiment_req` where `experiment_current_snapshot`='171'";
...
<form name="account">
	<br/><br/>
		...
		<tr><th colspan="4" class="theme-details-l">Ideas for IRB Reviews</th></tr>
	...
	//echo $sql;
			...
			?>
				<tr>
					...
					<td><a href="ideaunderreviews.php?req_no=<?php echo $row['request_num']?>" ><?php print $row['expt_shortname']; ?></a></td>	
