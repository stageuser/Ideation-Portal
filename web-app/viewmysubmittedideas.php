...
$owneremail = $_SESSION['short_id'];
	...
	/*if ($MetaID == 1)
		...
		*/
		...
		$where_cond_col = "owner_email_id";		//where condition col name
	...
	*/
	$query = "SELECT COUNT(*) as num FROM $tbl_name WHERE $where_cond_col = '$owneremail'";
	$total_pages = mysql_fetch_array(mysql_query($query));
	$total_pages = $total_pages[num];
	
	/* Setup vars for query. */
	$targetpage = "viewmysubmittedideas.php"; 	//your file name  (the name of this file)
	...
	{
	*/
		$sql = "SELECT * FROM $tbl_name WHERE $where_cond_col = '$owneremail' order by request_theme LIMIT $start, $limit";
		$skill_metadatas = mysql_query($sql);
	//}
...
<?php echo $pagination; ?>
	...
	<form name="account">
	<div align="right"><a href="viewsubmittedideas.php">Show All Ideas</a></div>
	<br/><br/>
		<table id="skillview" width="100%">
		<tr><th colspan="5" class="theme-details-l">View My Ideas</th></tr>
