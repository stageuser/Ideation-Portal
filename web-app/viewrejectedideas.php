...
*/
	...
	/*if ($MetaID == 1)
		...
		*/
		$sql="select * from csc_lr_experiment_req where experiment_current_snapshot='800' order by request_theme";
	...
	<br/><br/>
		...
		<tr><th colspan="4" class="theme-details-l">View Rejected Ideas</th></tr>
	...
	//echo $sql;
		...
		<div align="right">
		<br/>
		<input type="button" name="export_report" class="controltext" id="export_report" <?php if ($expt_snapshots_name=="") {?> disabled <?php }?> value="Export to Spreadsheet" onclick="javascript:window.open('rejectedideas_exporttoexcel.php');" >
		</div>
		<!--<div>
		<?php
