...
*/
	...
	/*if ($MetaID == 1)
		...
		*/
		$sql="select * from csc_lr_experiment_req where experiment_current_snapshot='96' order by request_theme";
	...
	<br/><br/>
		...
		<tr><th colspan="4" class="theme-details-l">View Tied Ideas</th></tr>
	...
	//echo $sql;
			...
			?>
				<tr>
					...
					<td><a href="movetiedideasfwd.php?req_no=<?php echo $row['request_num']; ?>"><?php print $row['expt_shortname']; ?></a></td>	
